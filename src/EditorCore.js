    ...
    Helper.equals = function (x, y) {
        ...
        return x && y && tx === 'object' && tx === ty
            ? ok(x).length === ok(y).length &&
                ok(x).every(function (key) { return _this.equals(x[key], y[key]); })
            : x === y;
    };
    return Helper;
}());
var Shared = /** @class */ (function () {
    ...
    Shared.prototype.wire = function (props) {
        var _this = this;
        Object.keys(props || {})
            .filter(function (p) { return /^on/.test(p); })
...
var Controlled = /** @class */ (function (_super) {
    ...
    Controlled.prototype.render = function () {
        ...
        var className = this.props.className
            ...
            : 'react-codemirror2';
        return <div className={className} ref={function (self) { return (_this.ref = self); }}/>;
    };
    return Controlled;
}(React.Component));
