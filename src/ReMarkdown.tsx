...
const ReMarkdown = (props: IReMarkdownProps) => {
  // debugger
  ...
  const defaultMenuCN: IReMarkdownMenuItem[] = [
    {
      name: 'bold',
  ...
  const defaultMenuEN: IReMarkdownMenuItem[] = [
    {
      name: 'bold',
  ...
  const menu = props.hideMenu ? null : (
    <div className='remarkdown-menu'>
      {menuItem.map((item: IReMarkdownMenuItem, index: number) => {
        ...
        return (
          <span key={index} className='remarkdown-icon-wrap'>
            {name === '|' ? (
  ...
  const wrapperClassName =
    'remarkdown ' +
    (fullScreen ? 'remarkdown-fullscreen' : 'remarkdown-normal')
  ...
  switch (editorState) {
    ...
    case EditorStates.splitpane: {
      ...
      return (
        <div className={wrapperClassName}>
          {menu}
          <div className='remarkdown-splitwrap'>
            <div className='remarkdown-splitpane-editor'>{editor}</div>
            <div className='remarkdown-splitpane-preview'>{preview}</div>
          </div>
        </div>
      )
    }
