...
const toggleBlock = ( editor: CodeMirror.Editor,
                      type: string,
                      state: ITextState,
                      startCharsArg: string,
                      endCharsArg?: string ) => {

	                    const endChars = (typeof endCharsArg === 'undefined') ? startCharsArg : endCharsArg;
...
const toggleBold = ( editor: CodeMirror.Editor, state: ITextState, blockStyles?: IBlockStyles ) => {
...
const toggleItalic = ( editor: CodeMirror.Editor, state: ITextState, blockStyles?: IBlockStyles ) => {
...
const toggleStrikethrough = ( editor: CodeMirror.Editor, state: ITextState, blockStyles?: IBlockStyles ) => {

  const block = blockStyles ? blockStyles.strikethrough : DefaultBlockStyles.strikethrough
...
const toggleHeadingBase = (editor: CodeMirror.Editor, direction: string, size?: number) => {
...
const toggleHeading = ( editor: CodeMirror.Editor ) => toggleHeadingBase( editor, 'smaller' )

const toggleLine = (editor: CodeMirror.Editor, stat: ITextState, name: string) => {
...
const replaceSelection = (editor: CodeMirror.Editor, active: boolean, startEnd: string [], url?: string) => {
