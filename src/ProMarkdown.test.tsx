...
describe("ProMarkdown default", () => {
  ...
  test("ProMarkdown root is mounted correctly", () => {
    ...
    expect(wrapper.is('.pro-markdown')).toBeTruthy()
  ...
  test("EditorCore is mounted correctly", () => {
    ...
    expect(wrapper.find('.pro-markdown-codemirror').length).toBe(1)

  })

  test("Menu is mounted correctly", () => {

    expect(wrapper.find('.pro-markdown-menu').length).toBe(1)

  })

  test("Default menu icons are rendered correctly", () => {

    expect(wrapper.find('.pro-markdown-icon-wrap').length).toBe(20)
...
describe("ProMarkdown custom menu", () => {
  ...
  test("Custom menu icons are rendered correctly", () => {
    ...
    expect(wrapper.find('.pro-markdown-icon-wrap').length).toBe(5)
